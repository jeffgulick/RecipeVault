    ...
    public static void Initialize(IServiceProvider serviceProvider)
    {
        ...
        context.Recipes.AddRange(
            ...
            new Recipe
            {
                ...
                CookTime = "30 Minutes",
                ImageURL = "img/grilledChicken.jpg",
            ...
            new Recipe
            {
                ...
                CookTime = "40 Mintues",
                ImageURL = "img/spaghettiBolognese.jpg",
                Category = categories[1],
                RecipeIngredients = new List<RecipeIngredient>
                {
            ...
            new Recipe
            {
                ...
                CookTime = "30 Minutes",
                ImageURL = "img/chickenAlfredo.jpg",
                Category = categories[1],
                RecipeIngredients = new List<RecipeIngredient>
                {
                    new RecipeIngredient { Ingredient = ingredients[6] }, // Chicken
            ...
            new Recipe
            {
                ...
                CookTime = "15 Minutes",
                ImageURL = "img/grilledCheese.png",
                Category = categories[2],
                RecipeIngredients = new List<RecipeIngredient>
                {
                    new RecipeIngredient { Ingredient = ingredients[3] },  // Flour
